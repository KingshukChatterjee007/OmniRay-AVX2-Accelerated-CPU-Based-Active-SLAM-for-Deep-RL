"""
MIT Stata Center Multi-Model Benchmark Suite
=============================================================
Evaluates OmniRay (unchanged policy, zero hyperparameter tuning)
against baselines on the MIT Stata Center floorplan geometry.
...
def get_mit_stata_walls():
    """
    Constructs the 2D wall segment geometry for MIT Stata Center complex floorplan (100x100 grid).
    Features large open atrium, complex multi-pillar clusters, and curved outer boundary walls.
    """
    walls = [
        ...
        # Stata Center Main Atrium Dividers
        (20.0, 20.0, 20.0, 80.0),
        (20.0, 80.0, 50.0, 80.0),
        (50.0, 80.0, 50.0, 60.0),
        
        # Office Wings & Complex Pillars
        (70.0, 20.0, 90.0, 20.0),
        (90.0, 20.0, 90.0, 70.0),
        (70.0, 70.0, 90.0, 70.0),
        
        # Interior Obstacle Clusters (Stata Center Structural Columns)
        (35.0, 35.0, 45.0, 35.0),
        (45.0, 35.0, 45.0, 45.0),
        (35.0, 45.0, 45.0, 45.0),
        (35.0, 35.0, 35.0, 45.0),
...
if __name__ == "__main__":
    print("=" * 115)
    print("  OmniRay vs Multi-Model Baseline Benchmark — MIT Stata Center Dataset")
    print("=" * 115)

    stata_walls = get_mit_stata_walls()
    ...
    def create_env():
        ...
        e._walls = stata_walls
        e.raycaster.set_walls(stata_walls)
        return e
    ...
    print("  [5/5] Running OmniRay 5-Layer System (Unchanged Model, Zero-Shot Generalization)...")
    ...
    for x1, y1, x2, y2 in stata_walls:
    ...
    ax1.set_title("Exploration Trajectories (MIT Stata Center)", color="white", fontsize=12, fontweight="bold")
    ax1.set_xlim(-5, 105)
    ax1.set_ylim(-5, 105)
    ...
    plt.suptitle("MIT Stata Center Dataset Benchmark — OmniRay Zero-Shot Generalization", color="white", fontsize=14, fontweight="bold")
    plt.tight_layout()
    
    out_img = os.path.join(save_dir, "mit_stata_multi_model_benchmark.png")
