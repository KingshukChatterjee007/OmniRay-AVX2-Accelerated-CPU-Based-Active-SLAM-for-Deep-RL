"""
MIT Stata Center Multi-Model Benchmark Suite (Multi-Seed & Wall-Time version)
=============================================================================
...
5. OmniRay (Ours) - 5-Layer Self-Adaptive System (Zero-Shot)
"""
...
if __name__ == "__main__":
    ...
    def create_env():
        ...
        e._walls = mit_walls
        e.raycaster.set_walls(mit_walls)
        return e
    ...
    ax1.set_title("Exploration Trajectories (MIT Stata - Seed 42 Representative)", color="white", fontsize=12, fontweight="bold")
    ax1.set_xlim(-5, 105)
    ax1.set_ylim(-5, 105)
    ...
    plt.suptitle("Multi-Seed Exploration Benchmark (MIT Stata Center)", color="white", fontsize=14, fontweight="bold")
    plt.tight_layout()
