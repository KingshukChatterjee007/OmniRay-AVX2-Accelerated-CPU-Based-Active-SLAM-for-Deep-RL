...
\caption{\textbf{Intel Research Lab Multi-Model Benchmark:} Comparative evaluation of Exploration Trajectories and Coverage Progression over 300 simulation steps against classical and learning-based baselines under physical noise.}
...
\caption{\textbf{MIT Stata Center Zero-Shot Benchmark:} Exploration trajectories and coverage rate progression on the MIT Stata Center dataset (\texttt{MIT dataset.bag}) evaluated zero-shot without policy retraining or hyperparameter tuning.}
